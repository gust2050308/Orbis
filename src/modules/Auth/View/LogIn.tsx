    ...
    return (
        <div className='w-full px-5 rounded-lg'>
            ...
            <div className='w-full flex flex-col'>
                <form id='logInForm' onSubmit={logInForm.handleSubmit(async (data) => {
                    ...
                    <FieldGroup className='gap-5'>
                        ...
                        />
                        <Field>
                            <Button type="submit" form="logInForm" className='cursor-pointer bg-gradient-to-r from-[#256EFF] to-blue-700 hover:scale-105 transition-transform duration-300 w-full'>
                                <p>Iniciar sesión</p>
                            </Button>
                        </Field>
            ...
            <div className='w-full flex flex-col mt-4'>
                ...
                <div>
                    <Button variant="outline" className='w-full mt-4 cursor-pointer' onClick={() => { LoginWithGoogle() }} >
